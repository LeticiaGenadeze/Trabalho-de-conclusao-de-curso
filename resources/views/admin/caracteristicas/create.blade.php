                        ...
                        <form class="form form-horizontal" action="{{route('admin.caracteristicas.store')}}" method="POST">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="first-name" class="form-control" name="note" placeholder="Nota" value="{{old('note')}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label>Tipo</label>
                                    </div>
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="first-name" class="form-control" name="type" placeholder="Tipo" value="{{old('type')}}">
                                    </div>                                 
